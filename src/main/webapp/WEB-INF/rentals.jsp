...
<div class="content-container">
    ...
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
        ...
        <a href="<%=path%>/addRental"
           style="background:#2ecc71; color:white; padding:12px 20px; border-radius:5px; text-decoration:none; font-weight:bold; transition: 0.3s;">
            + Create New Booking
        </a>
        <% } %>
    </div>
    ...
    <table>
        ...
        <tr>
            <td>
                <strong><%=rental.getCar().getBrand()%>
                </strong> <%=rental.getCar().getModel()%>
            </td>
            ...
            <td class="price-text">$<%= String.format("%.2f", rental.getTotalCost()) %>
            </td>
        ...
        <tr>
            <td colspan="<%= (currentUser != null) ? 7 : 6 %>"
