...
<div class="content-container">
    ...
    <div style="display: flex; justify-content: space-between; align-items: center;">
        ...
        <a href="<%=path%>/addCar"
           style="background:#2ecc71; color:white; padding:10px; border-radius:5px; text-decoration:none;">+ Add Car</a>
        <% } %>
    </div>
    ...
    <table>
        ...
        <tr>
            ...
            <% if (currentUser != null) { %>
            <td>
                <a href="<%=path%>/addRental?id=<%=car.getId()%>" class="btn-admin change">Rent</a>
            </td>
            <% } %>
        </tr>
        <% } %>
